...
class Programmer : public Employee
{
    ...
    public:
        ...
        Programmer(int departmentNumber, string supervisorName, float percentageIncrease, bool knowsCpp, bool knowsJava) 
            : departmentNumber{departmentNumber}, supervisorName{supervisorName},knowsCpp{knowsCpp}, knowsJava{knowsJava} {}
        ~Programmer(){}
		...
		void printProgrammerHeader() const;
		void printProgrammerData() const;
};
